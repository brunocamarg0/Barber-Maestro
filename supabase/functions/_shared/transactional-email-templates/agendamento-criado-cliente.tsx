...
const Email = ({ nome = 'Cliente', barbearia = 'a barbearia', servico = 'seu serviço', dataHora = '', horario = '' }: Props) => (
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Recebemos sua solicitação de agendamento em {barbearia}</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>Olá, {nome}!</Heading>
        <Text style={text}>Recebemos sua solicitação de agendamento em <strong>{barbearia}</strong>. ✂️</Text>
        <Section style={box}>
        ...
        <Text style={text}>Assim que a barbearia confirmar, você receberá um novo e-mail. Um lembrete será enviado 24h e 2h antes do horário.</Text>
...
export const template = {
  ...
  displayName: 'Agendamento — Solicitação recebida (cliente)',
